...
class Brands extends ResourceController
{
    ...
    public function index()//Listar todas las marcas
    {
    ...
    public function show($id = null)//Buscar marca por id.
    {
        $model = new BrandModel();
    ...
    public function create()//Crear marca
    {
        $model = new BrandModel();
    ...
    public function update($id = null)//Actualizar marca
    {
        $model = new BrandModel();      
        $json = $this->request->getJSON();
        $data = [
    ...
    public function delete($id = null)//Eliminar marca
    {
        $model = new BrandModel();
        $result = $model->find($id);
        $response = null;
